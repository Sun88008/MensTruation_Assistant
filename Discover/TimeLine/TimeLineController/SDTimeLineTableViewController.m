...
- (NSArray *)creatModelsWithCount:(NSInteger)count
{
    ...
    NSArray *textArray = @[@"大概没有一个女性在痛经时不曾“求助于”生姜红糖水。大多时候，红糖都是在女性经前或经期才出现在公众视野。作为“妇女之友”的红糖用处可不少，其功效更是不容小觑。每100克红糖含钙90毫克，含铁4毫克，还含有少量的核黄素及胡萝卜素。日本科研人员还从红糖中提取了一种叫做“糖蜜”的多糖，实验证明它具有较强的抗氧化功效，对于抗衰老有明显的作用。",
                           @"姨妈巾是每个女生所需的贴身私密产品，它对女性朋友的重要性是不可言喻的。然而现在市面上的卫生巾琳琅满目，完全不知道应该选什么样的卫生巾。",
                           ...
                           @"小仙女们下次再来M的时候，千万不要盲目选择卫生巾哦~",
                           @"西医认为经期不能洗头是没有医学根据的，但中医的理论就不然。中医认为头为六阳之首，子宫为任脉的起点，生理期间，血液循环本来就比较差。洗头会造让血液集中至头部，容易造成经血量的减少或经痛。"
                           ];
